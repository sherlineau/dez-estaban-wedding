...
import ceremonyImg from "../../assets/images/ceremony.png";
import receptionImg from "../../assets/images/reception.png";

const VenueInfo = () => {
  // disabled google maps api -> switched to png images of map locations
  // const ceremony = {
      ...
      <div className="maps">
        <div className="venue">
          ...
          <div className="venue-location">
            <img src={ceremonyImg} alt="223 S Encinitas Ave" />
            <a href="https://www.google.com/maps/dir//223+South+Encinitas+Avenue,+Monrovia,+CA/@34.1493869,-118.0353031,13z/data=!4m8!4m7!1m0!1m5!1m1!1s0x80c2d941e5049627:0x9910c29904750820!2m2!1d-118.0001978!2d34.1493919">
              Ceremony Located at: 223 S Encinitas Ave
            </a>
          ...
          <div className="venue-location">
            <img src={receptionImg} alt="802 Mateo St" />
            <a href="https://www.google.com/maps/dir//802+Mateo+St,+Los+Angeles,+CA+90021/@34.0332257,-118.2475298,14.45z/data=!4m8!4m7!1m0!1m5!1m1!1s0x80c2c621a128eef5:0x2bc4f2135252f69b!2m2!1d-118.2320577!2d34.0334215">
              Reception Located at: 802 Mateo St
            </a>
            <div className="parking">
        ...
        <div className="parking">
          ...
          <ul>
            <li>
              ...
              <a
                href="https://www.hyatt.com/en-US/hotel/california/hyatt-place-pasadena/laczp?src=corp_lclb_gmb_seo_laczp#quickbook"
                target="_blank"
                rel="noreferrer"
              >
                Link
            ...
            <li>
              ...
              <a
                href="https://www.marriott.com/en-us/hotels/laxsp-sheraton-pasadena-hotel/overview/?scid=f2ae0541-1279-4f24-b197-a979c79310b0"
                target="_blank"
                rel="noreferrer"
              >
                Link
            ...
            <li>
              Hilton Pasadena
              <a
                href="https://www.hilton.com/en/book/reservation/rooms/?ctyhocn=PASPHHF"
                target="_blank"
                rel="noreferrer"
              >
                Link
            ...
            <li>
              The Westin Pasadena
              <a
                href="https://www.marriott.com/en-us/hotels/laxpw-the-westin-pasadena/"
                target="_blank"
                rel="noreferrer"
              >
                Link
